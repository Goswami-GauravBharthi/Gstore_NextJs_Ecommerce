    ...
    return (
        <div className="flex items-center justify-between px-12 py-4 border-b border-secondary/10 bg-surface/50 transition-all">
            <Link href="/" className="relative text-4xl font-semibold text-text-main font-serif">
                ...
                <p className="absolute text-xs font-semibold -top-1 -right-13 px-3 p-1 rounded-full flex items-center gap-2 text-primary-foreground bg-primary border text-center border-white/20 shadow-sm">
                    Admin
                </p>
            </Link>
